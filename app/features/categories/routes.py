...
from .services import (create_category, delete_category, get_all_categories,
                      get_categories_paginated, get_category_by_id,
                      update_category)
...
def categories_list_ui():
    ...
    if per_page == -1:
        ...
        categories, total_count, current_page, total_pages = get_categories_paginated(
            page, per_page
        )
